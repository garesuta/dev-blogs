---
name: md
description: Write clean, error-free markdown that IDEs and linters can parse without warnings. Use when writing documentation, README files, or claude-skill files with code examples.
