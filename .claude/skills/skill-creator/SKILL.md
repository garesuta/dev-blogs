...
description: Guide for creating effective skills. This claude-skill should be used when users want to create a new claude-skill (or update an existing claude-skill) that extends Claude's capabilities with specialized knowledge, workflows, or tool integrations.
...
```bash
scripts/init_skill.py <claude-skill-name> --path <output-directory>
```
...
```bash
scripts/package_skill.py <path/to/claude-skill-folder>
```

Optional output directory specification:

```bash
scripts/package_skill.py <path/to/claude-skill-folder> ./dist
```
